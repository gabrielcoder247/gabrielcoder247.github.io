const projectData = [{
  id: 0,
  name: 'Rentorbuy',
  image: 'images/realonerent.png',
  description: 'This is an application the helps you to views apartment, flats, mansionnet, and booking views to see the owner or the management ',
  tech: ['CSS', 'HTML', 'Django'],
  live: 'https://realonetwo.herokuapp.com/',
...
},
{
  id: 1,
  name: 'One-cart',
  image: 'images/one-cart.png',
  description: 'One-cart is an application that helps you shop owner, so that their customers can shop online and make transaction online with a cart feature which is very dynamic and slacky in design',
  tech: ['CSS', 'HTML', 'Nodejs', 'React'],
  live: 'http://one-cart.herokuapp.com/',
  source: 'https://github.com/gabrielcoder247/ShoppingCart',
  btnLive: 'see live',
  btnSource: 'see source',
  btnImgGit: 'images/ic_github.png',
  btnImgTeal: 'images/ic_link_teal.png',
...
},
{
  id: 2,
  name: 'Car rentals',
  image: 'images/react-captone-front-end.png',
  description: 'Welcome! Now you are thinking about a mean of transportation. Car rental is perhaps the best solution compared to all the other possibilities. High standards of mobility and safety are guaranteed. It makes you free from usage of public transport, and gives you power to ignore the weather conditions. Moreover, it is cheaper than taking a taxi.',
  tech: ['CSS', 'HTML', 'Rails'],
  live: 'https://mic-car-rental.netlify.app/',
  source: 'https://github.com/Taher-web-dev/car-rent-front-end',
  btnLive: 'see live',
  btnSource: 'see source',
  btnImgGit: 'images/ic_github.png',
  btnImgTeal: 'images/ic_link_teal.png',
